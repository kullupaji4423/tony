                ...
                <div className="bg-white rounded-lg p-8 shadow-lg transform rotate-1 relative" 
                  ...
                  <div className="space-y-4 font-handwriting text-lg text-gray-700">
                    <p className="animate-fade-in animation-delay-100">
                      I wanted to take a moment to say how truly sorry I am... Sometimes my words come out wrong, 
                      actions don't match intentions, and feelings get hurt along the way....
                    </p>
                    <p className="animate-fade-in animation-delay-200">
                      You mean the world to me... and the very most thing i dont wanna do is cause you pain... 
                      I've been reflecting on what is happening lately, and I realize now how my childish and illogical behaviour is causing trouble to you.
                    </p>
                    <p className="animate-fade-in animation-delay-300">
                      I promise to get better...to listen more...and to be the person you deserve... 
                      Our bond is too important to let misunderstandings come between us.
                    </p>
